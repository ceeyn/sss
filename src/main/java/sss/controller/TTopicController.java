...
public class TTopicController {
	...
	private final TTopicService service;

	@Autowired
	public TTopicController(TTopicService service) {
	...
	public List<TTopicEntity> select(@RequestBody TTopicEntity entity) {
	...
	public PageData<TTopicEntity> likeSelect(@RequestBody TTopicEntity entity) {
	...
	public void update(@RequestBody TTopicEntity entity) {
	...
	public void add(@RequestBody TTopicEntity entity) {
		service.add(entity);
	}
	...
	public void delete(@RequestBody TTopicEntity entity) {
