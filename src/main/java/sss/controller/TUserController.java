...
public class TUserController {
	...
	@Autowired
	public TUserController(TUserService service) {
	...
	public List<TUserEntity> select(@RequestBody TUserEntity entity) {
	...
	public PageData<TUserEntity> likeSelect(@RequestBody TUserEntity entity) {
	...
	public void update(@RequestBody TUserEntity entity) {
	...
	public void add(@RequestBody TUserEntity entity) {
		service.add(entity);
	}
	...
	public void delete(@RequestBody TUserEntity entity) {
